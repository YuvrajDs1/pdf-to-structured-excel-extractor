...
This project provides a user-friendly, AI-powered tool for converting unstructured PDF documents into fully structured Excel files. Using modern LLMs (via :contentReference[oaicite:0]{index=0}) and a simple upload interface built with :contentReference[oaicite:1]{index=1}, you can extract **all text**, detect key:value pairs with context, preserve original language, and export the output to `.xlsx`.  
